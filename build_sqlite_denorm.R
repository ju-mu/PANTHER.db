...
CREATE TABLE protein_class_parents (
...
CREATE INDEX lprotein_class_parents_idx ON protein_class_parents(class_tree_id,parent_class_id);
CREATE INDEX rprotein_class_parents_idx ON protein_class_parents(parent_class_id,class_tree_id);
...
CREATE INDEX species_idx ON uniprot(species);
...
metadata <- rbind(
  ...
  c("package","PANTHER.db"),
  c("Db type","PANTHER"),
  c("DBSCHEMAVERSION", "x.x")
)
